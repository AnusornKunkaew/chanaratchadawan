			...
			<!-- Banner -->
				<section id="banner">
					...
					<div class="inner">
						...
						<header >
                        <div class="image2">
                            <img src="images/LOGO CHANA png.png" width="350" />
                       </div>
						</header>
						<p>This is <strong>My Denture</strong>, a supreme
						<br />
						Dental Laboratory
						<br />
						by <a href="">CHANA RATCHADAWAN</a>.</p>
						<footer>
							<ul class="buttons vertical">
								<li><a href="#main" class="button fit scrolly">รู้จักเรายิ่งขึ้น</a></li>
							</ul>
						</footer>
			...
			<!-- Main -->
				<article id="main">
					...
					<header class="special container">
						...
						<br />
						released for free under the <a href="http://www.chanaratchadawan.com">Creative Commons Attribution 3.0</a> license. Have fun!</p>
					</header>
						...
						<section class="wrapper style3 container special">
							...
							<div class="row">
								<div class="6u 12u(narrower)">
									...
									<section>
										<a  class="image featured"><img src="images/ชนะรัชดาวรรณ3.jpg" alt="" /></a>
										<header>
							...
							<div class="row">
								<div class="6u 12u(narrower)">
									...
									<section>
										<a class="image featured"><img src="images/ชนะรัชดาวรรณ1.jpg" alt="" /></a>
										<header>
								...
								<div class="6u 12u(narrower)">
									...
									<section>
										<a class="image featured"><img src="images/ชนะรัชดาวรรณ2.jpg" alt="" /></a>
										<header>
